...
function make_oidc(oidcConfig)
  ...
  local res, err = require("kong.plugins.oidc.openidc").authenticate(oidcConfig, ngx.var.request_uri, unauth_action)
...
function verify_bearer_jwt(oidcConfig)
  ...
  local json, err, token = require("kong.plugins.oidc.openidc").bearer_jwt_verify(opts, claim_spec)
  if err then
